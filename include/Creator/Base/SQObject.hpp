...
namespace Creator::Entity
{
    ...
    struct ArchetypeFeature: public SQObject, public SheetDisplay, public SpellcastingBase
    {
    ...
    struct RacialTrait: public SQObject, public SheetDisplay, public SpellcastingBase
    {
    ...
    struct SubRace: public SQObject, public SheetDisplay
    {
    ...
    struct Archetype: public SQObject, public SheetDisplay, public SpellcastingBase
    {
    ...
    struct Race: public SQObject, public SheetDisplay, public SpellcastingBase
    {
    ...
    struct Class: public SQObject, public SheetDisplay, public SpellcastingBase, public MultiClass
    {
    ...
    struct CompanionTrait: public SQObject, public SheetDisplay
    {
    ...
    struct CompanionReaction: public SQObject, public SheetDisplay
    {
    ...
    struct Proficiency: public SQObject, public SheetDisplay
    {
    ...
    struct BackgroundVariant: public SQObject, public SheetDisplay
    {
    ...
    struct Grants: public SQObject, public SpellcastingBase
    {
